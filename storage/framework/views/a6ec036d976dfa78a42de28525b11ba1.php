    ...
    <div class="row justify-content-center align-items-center min-vh-100">
        <div class="col-md-6 col-lg-5">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(url('/login')); ?>" method="post" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\virus\OneDrive\Desktop\techsupport\resources\views/auth/login.blade.php ENDPATH**/ ?>